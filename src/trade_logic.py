...
ES = pd.read_csv(r"./Source files/emini s&p.csv") # convert to raw string
NQ = pd.read_csv(r"./Source files/nasdaq.csv")
CL = pd.read_csv(r"./Source files/crude oil.csv")
NG = pd.read_csv(r"./Source files/natural gas.csv")
ZB = pd.read_csv(r"./Source files/30yr t-bond.csv")
ZN = pd.read_csv(r"./Source files/10 yr t-note.csv")
specs = pd.read_csv(r"./Source files/contract specifications.csv")
